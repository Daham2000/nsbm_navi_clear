...
class AppBarLogo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(left: Assets.paddingAppbar),
      child: Column(
...
class SubCategory extends StatelessWidget {
  ...
  SubCategory(dynamic item, String n, List<dynamic> favListParam, {Key? key})
      : super(key: key) {
    i = item;
    name = n;
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      ScaffoldMessenger.of(context)
                                        ...
                                        backgroundColor:
                                            StyledColor.blurPrimary,
                                      ));
                                      await LocationApi()
                                          .updateLocationFav(name, t);
                                      ScaffoldMessenger.of(context)
                                          .hideCurrentSnackBar();
                                    },
                                    child: const Icon(
